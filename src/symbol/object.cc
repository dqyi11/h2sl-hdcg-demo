...
type_to_std_string( const unsigned int& type ){
  ...
  case( OBJECT_TYPE_BOX1 ):
    return "box1";
    break;
  case( OBJECT_TYPE_BOX2 ):
    return "box2";
    break;
  case( OBJECT_TYPE_BOX3 ):
    return "box3";
    break;
  case( OBJECT_TYPE_BOX4 ):
    return "box4";
    break;
  case( OBJECT_TYPE_BOX5 ):
    return "box5";
    break;
  case( OBJECT_TYPE_BOX6 ):
    return "box6";
    break;
  case( OBJECT_TYPE_BOX7 ):
    return "box7";
    break;
  case( OBJECT_TYPE_BOX8 ):
    return "box8";
    break;
  case( OBJECT_TYPE_BOX9 ):
    return "box9";
    break;
