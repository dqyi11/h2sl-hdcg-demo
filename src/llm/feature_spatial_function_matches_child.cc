...
Feature_Spatial_Function_Matches_Child( const bool & invert ) : Feature( invert ) {
...
Feature_Spatial_Function_Matches_Child::
Feature_Spatial_Function_Matches_Child( const Feature_Spatial_Function_Matches_Child& other ) : Feature( other ) {
