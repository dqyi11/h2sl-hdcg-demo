 ...
 * @section DESCRIPTION
 *
 * The interface for a class used to check for a match between a grounding object's object and a child object object
 */
...
namespace h2sl {
  ...
  std::ostream& operator<<( std::ostream& out, const Feature_Object_Matches_Child& other );
}
